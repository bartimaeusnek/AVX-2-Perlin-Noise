...
public unsafe partial class Perlin
{
	...
	public float OctavePerlin(float x, float y, float z, int nOctaves = 8, float persistence = 0.5f, float lacunarity = 2.0f, float scale = 10.0f)
	{
		var freq  = 1.0f;
		var amp   = 1.0f;
		var max   = 0.0f;
	...
	[ExcludeFromCodeCoverage]
	public double OctavePerlin(double x, double y, double z, int nOctaves = 8, double persistence = 0.5d, double lacunarity = 2.0d, double scale = 10.0d)
	{
		var freq  = 1.0d;
		var amp   = 1.0d;
		var max   = 0.0d;
	...
	[ExcludeFromCodeCoverage]
	public int[] PerlinHash(int xi, int yi, int zi)
	{
		var a  = p[xi]     + yi;
		var aa = p[a]      + zi;
		var ab = p[a  + 1] + zi;
